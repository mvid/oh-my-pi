...
export interface InteractiveModeContext {
	 ...
	 * `modelSelectors` is the caller-resolved per-provider model list; omitting
	 * it lets the dashboard walk the registry itself.
	 */
	showUsageDashboard(reports: UsageReport[], modelSelectors?: string[]): void;
