...
- **Static Seeds**: Declared in `packages/catalog/src/compat/rules/providers/bedrock-mantle.kdl` and exposed through `seedModels("bedrock-mantle")` with 5 OpenAI models (`openai.gpt-5.4`, `openai.gpt-5.5`, `openai.gpt-5.6-luna`, `openai.gpt-5.6-sol`, `openai.gpt-5.6-terra`) defining context windows, max tokens, pricing, and thinking effort specs.
